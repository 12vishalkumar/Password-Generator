...
#************************************ Required variables and layout ************************************
root = Tk()
root.resizable(width=False, height=False)
root.title("Password generation App" + str(__version__))
...
def savepass():
    file_name = fd.asksaveasfilename(filetypes=(("TXT files", "*.txt"), ("All files", "*.*")), defaultextension='')
    try:
        f = open(file_name, 'w')
